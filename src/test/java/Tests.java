...
public class Tests {
    ...
    public void Base_tests_1(){
        ...
        int current_min = Main._min(array);
        Assert.assertEquals(current_min, 1);
        Assert.assertEquals(Main._max(array), 56);
        Assert.assertEquals(Main._mult(array), 6720);
        Assert.assertEquals(Main._sum(array), 71);
    }
    @Test
    public void Base_tests_2(){
        ...
        int current_min = Main._min(array);
        Assert.assertEquals(current_min, 1);
        Assert.assertEquals(Main._max(array), 15);
        Assert.assertEquals(Main._mult(array), 2027025);
        Assert.assertEquals(Main._sum(array), 64);
    }
    @Test
    ...
    public void Time_test_1(){
        ...
        //запускаю функции
        int current_min = Main._min(array);
        int current_max = Main._max(array);
        int current_mult = Main._mult(array);
        int current_sum = Main._sum(array);
